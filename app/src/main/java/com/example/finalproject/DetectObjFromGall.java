    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAddPersonFab.setOnClickListener(view -> {
            try {
                ...
                MotionToast.Companion.darkColorToast(DetectObjFromGall.this,"Please pick color", MotionToast.TOAST_WARNING, MotionToast.GRAVITY_CENTER, MotionToast.SHORT_DURATION,
                        ResourcesCompat.getFont(DetectObjFromGall.this, R.font.helvetica_regular));
            }
        });
