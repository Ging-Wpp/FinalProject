...
//            Intent intent1 = new Intent(FindColor.this, FindColorFromCamera.class);
...
//                }
        ...
        storage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(FindColor.this,Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
                    ActivityCompat.requestPermissions(FindColor.this,new String[] { Manifest.permission.READ_EXTERNAL_STORAGE },1);
                }
                else {
                    Toast.makeText(FindColor.this,"Permission already granted",Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && resultCode == FindColor.RESULT_OK && data!=null) {
            try {
                ...
                Intent intent = new Intent(FindColor.this,Fcgallery.class);
