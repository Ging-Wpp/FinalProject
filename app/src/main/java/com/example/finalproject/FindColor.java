...
public class FindColor extends AppCompatActivity implements OnTouchListener, CvCameraViewListener2 {

    private static final String TAG = "FindColor";
    private Mat mRgba;
    private Scalar mBlobColorRgba,mBlobColorHsv;
    private ColorBlobDetector mDetector;
    private TextView rgb, HexCode, Name;
    ...
    private final BaseLoaderCallback mLoaderCallback = new BaseLoaderCallback(this) {
        ...
        public void onManagerConnected(int status) {
            if (status == LoaderCallbackInterface.SUCCESS) {
                ...
                mOpenCvCameraView.setOnTouchListener(FindColor.this);
            } else {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        camera.setOnClickListener(v -> {
            Intent intent1 = new Intent(FindColor.this, FindColor.class);
        ...
        logo.setOnClickListener(view -> {
            Intent intent = new Intent(FindColor.this,MainActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 0 && resultCode == FindColor.RESULT_OK) {
            try {
                Intent intent = new Intent(FindColor.this,FindColor.class);
        ...
        if (requestCode == 1 && resultCode == FindColor.RESULT_OK ) {
            try {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        try {
            ...
            Log.d(TAG,"submat: " + touchedRegionRgba);
            ...
            TextView rgb = findViewById(R.id.resultTv);
            TextView hexcp = findViewById(R.id.hex);
            ...
            MotionToast.Companion.darkColorToast(FindColor.this, "Please pick color in camera", MotionToast.TOAST_WARNING, MotionToast.GRAVITY_CENTER, MotionToast.SHORT_DURATION,
                    ResourcesCompat.getFont(FindColor.this, R.font.helvetica_regular));
        }
        return false;
    }
